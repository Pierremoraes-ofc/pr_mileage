-- ============================================================
--   pr_mileage — detecção de framework (espelha lógica do pr_bridge)
--   Usa GetResourceState para detectar qual framework está ativo,
--   na mesma ordem de prioridade do pr_bridge/bridge/config.lua
...
-- Ordem de prioridade idêntica ao pr_bridge

...
--
--   Cada peça define:
--     durability  → { min, max } KM ou MPH de vida útil (sorteado ao registrar)
...
--  @param              → params.durability     - define a durabilidade em km ou mph antes de estourar
--  @param              → params                - tabela de parâmetros
--  @param              → params.wheel          - define a roda a ser aplicada efeito 
--  nil = randomiza a roda
--  0   = dianteira esquerda | dianteira de bicicleta, avião ou jato
        ...
        symptoms   = {
            {
                ...
                effects   = {
                    ...
                    { type = "tyre_flat", params = { wheel = nil, durability = 15 } },
                },
            },
            {
                threshold = 0.35,
    ...
    ['tire_drift'] = {
        ...
        symptoms   = {
            ...
            },
            {
                ...
                effects   = {
                    { type = "shake_cam", params = { type = "ROAD_VIBRATION_SHAKE", speed = 50, intensity = 0.01 } },
                    { type = "tyre_flat", params = { wheel = 4, durability = 15 } },
                },
            },
        },
    },
